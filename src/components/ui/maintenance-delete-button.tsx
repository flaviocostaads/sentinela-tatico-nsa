...
interface MaintenanceDeleteButtonProps {
  logId: string;
  onDelete: () => void;
}

const MaintenanceDeleteButton = ({ logId, onDelete }: MaintenanceDeleteButtonProps) => {
  ...
  const handleDelete = async () => {
    try {
      ...
      toast({
        title: "Erro",
        description: "Erro ao excluir registro de manutenção",
        variant: "destructive",
      });
    } finally {
      setIsDeleting(false);
...
export default MaintenanceDeleteButton;