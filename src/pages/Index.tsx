...
const Index = () => {
  ...
  const [stats, setStats] = useState({
    ...
    vehiclesInField: { cars: 0, motorcycles: 0 },
    complianceRate: 0
  });
  ...
  const fetchDashboardStats = async () => {
    try {
      ...
      const { data: checkpointVisits } = await supabase
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">
                Monitoramento em tempo real das operações de segurança
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1">
              {selectedRound ? (
                ...
                <ActiveRoundsCard onRoundSelect={setSelectedRound} />
              )}
            </div>
          </div>
        </main>
