...
DROP POLICY IF EXISTS "Taticos and operadores can create fuel logs" ON vehicle_fuel_logs;
...
DROP POLICY IF EXISTS "Taticos and operadores can create maintenance logs" ON vehicle_maintenance_logs;
...
DROP POLICY IF EXISTS "Taticos can create incidents" ON incidents;
