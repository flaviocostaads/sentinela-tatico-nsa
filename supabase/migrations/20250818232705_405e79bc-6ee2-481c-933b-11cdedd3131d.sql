...
-- Create vehicle maintenance schedules table (simplified without computed column)
...
CREATE TRIGGER update_maintenance_schedule_after_service
  AFTER INSERT ON public.vehicle_maintenance_logs
  FOR EACH ROW
  WHEN (NEW.end_time IS NOT NULL)
  EXECUTE FUNCTION public.update_maintenance_schedule_after_service();